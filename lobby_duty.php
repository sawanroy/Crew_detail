...
<div class="row">
        <div class="col">
            <h2 class="mb-1">Lobby Detail</h2>
        </div>
        <div class="col">
            <h2 class="mb-1">Monday</h2>
        </div>
        <div class="col">
            <h2 class="mb-1">13/08/2025</h2>
        </div>
    </div>
...
<div class="container mt-4">
<div class="col">
            <h2 class="mb-1">OFFICE ORDER FOR KTE LOBBY - DATE</h2>
        </div>
...
$(document).ready(function() {
    ...
    function addRow() {
        ...
        newRow.append($('<td>').html(selectLP));
         // Add other LP inputs
         newRow.append($('<td>').html('<input type="text" name="nonrun_lp[]" class="form-control">'));
        newRow.append($('<td>').html('<input type="text" name="from_lp[]" class="form-control">'));
        newRow.append($('<td>').html('<input type="text" name="to_lp[]" class="form-control">'));
        newRow.append($('<td>').html('<input type="text" name="porest_lp[]" class="form-control">'));
        ...
        newRow.append($('<td>').html(selectALP));
         ...
         newRow.append($('<td>').html('<input type="text" name="nonrun_alp[]" class="form-control">'));
        newRow.append($('<td>').html('<input type="text" name="from_alp[]" class="form-control">'));
        newRow.append($('<td>').html('<input type="text" name="to_alp[]" class="form-control">'));
