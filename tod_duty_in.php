...
<div class="col">
            <h2 class="mb-1">TOD- INCOMING TRAINS </h2>
        </div>
...
$(document).ready(function() {
    ...
    function addRow() {
        ...
        newRow.append($('<td>').html('<input type="text" name="in_train[]" class="form-control">'));
        newRow.append($('<td>').html('<input type="text" name="out_train[]" class="form-control">'));
        newRow.append($('<td>').html('<input type="text" name="sch_arrival[]" class="form-control">'));
